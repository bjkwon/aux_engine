...
using auxGraphicsFigureFromHandleHook = uint64_t(*)(void* userdata, uint64_t handle_id, string& errstr);
...
struct auxGraphicsBackend {
    ...
    auxGraphicsFigureFromHandleHook figure_from_handle = nullptr;
